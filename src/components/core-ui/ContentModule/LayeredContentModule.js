...
const LayeredContentModule = ({ addImage, blob, imageDirection, imageMargin, imageAlt, imageBlobAlt, headerContent, paragraphContent, linkTo, variant, mobileClass, desktopClass }) => {
  return (
    <div className={`LayeredContentModule ${mobileClass} md:${desktopClass}`}>
      <div className={`flex flex-col md:justify-center ${imageDirection}`}>
        <div className={`LayeredContentModule_content text-center md:text-left md:w-1/2`}>
          ...
          <FixedButtonLink addLinkClass="" addClass="mb-16" textContent="View Case Study" linkTo={linkTo} variant={variant} />
        </div>
